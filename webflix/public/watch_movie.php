<?php
	...
	# Retrieve items from 'webflix_movies' database table
	...
	if( mysqli_num_rows( $r ) > 0 ){
		...
		# If the user is already subscribed display the movie
		if ($subscribed > 0){
				...
				echo '
					...
					<div class="row">
						<div class="embed-responsive embed-responsive-16by9">
							<iframe class="embed-responsive-item" src='. $row['movie_url'].' 
		...
		# mysqli_close( $link );
	} else { echo '<h3>This movie is not availble</h3>'; }
