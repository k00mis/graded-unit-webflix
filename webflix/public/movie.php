...
$q = "SELECT * FROM webflix_movies WHERE id = $id" ;
...
if ( mysqli_num_rows( $r ) == 1 )
{
  ...
  if ($subscribed > 0){ 
    ...
    echo '
			...
			<div class="container">
			<h1 class="display-4" style="color:#ffffff!important;">'.$row['movie_title'].'</h1>
		<div class="row">
			...
			<div class="col-sm-12 col-md-4">
				...
				<a href="watch_movie.php?id='.$row['id'].'">
				<span class="btn btn-secondary">Watch now! </span></a>  
			</div>
		</div>
		';
  }
else
  { # If the user is not subscribed, display the appropriate message and "subscribe now" button
 echo '<head>
		<link rel="stylesheet" type="text/css" href="includes/cinema_style.css">
		</head>
		<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-12 col-md-4">
				...
				<p>Duration: '.$row['duration'].' minutes</p>
				<h4 style="color:#ffffff!important;">Ready to watch?</h4>
				<p> Streaming full films is a premium feature exclusive to Webflix Subscribers.</p>
